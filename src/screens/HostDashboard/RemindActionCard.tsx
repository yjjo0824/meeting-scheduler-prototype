  ...
  return (
    <Card className="flex flex-col justify-between gap-4">
      <div className="space-y-2">
        <h3 className="text-lg font-bold text-ink-900">{pendingPersonName} 님의 답변을 기다리고 있어요</h3>
        <p className="text-sm text-ink-700">답변이 오면 추천 시간이 달라질 수 있어요.</p>
        <div className="flex items-center gap-3" aria-label={`${total}명 중 ${respondedCount}명 답변 완료`}>
