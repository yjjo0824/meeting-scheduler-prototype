  ...
  return (
    <section className="space-y-1 py-4">
      ...
      <textarea
        ...
        rows={4}
        className="mt-1 w-full rounded-chip border border-border p-3 text-sm leading-relaxed text-ink-900 outline-none placeholder:text-ink-500 focus:border-brand-600 focus:ring-2 focus:ring-brand-100"
