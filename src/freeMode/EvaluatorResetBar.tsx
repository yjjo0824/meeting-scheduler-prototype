...
// 기준점이다(12C-7): freeModeUnlocked와 무관하게 항상 마운트되는 유일한 진입점이므로 항상
// 이 자리에 있고, 그 위(bottom-16)는 투어 중에는 가이드 카드가, 투어가 끝나면 "다른 역할
// 체험하기" pill이 차지한다(12C-10 — 같은 자리를 이어받아 공간이 자연스럽게 이어진다).
